/**
 * @fileOverview Nexvoro AI Master Question Data (v7.0 - Production Grade).
...
export const MASTER_QUESTIONS: CodingQuestion[] = [
  // --- EASY CATEGORY ---
  {
    ...
    outputFormat: "Print one word: YES if it is a Mirror Word, otherwise print NO.",
    constraints: [
      "- 1 <= word length <= 10,000",
      "- Includes English alphabets and numbers only.",
      "- Case sensitivity matters (A is not the same as a)."
    ],
    sampleInput: "racecar",
    sampleOutput: "YES",
  ...
  },
  {
    ...
    company: "Accenture",
    tags: ["Arrays", "Logic"],
    inputFormat: "First line contains an integer N, the total number of players. Second line contains N space-separated integers representing the scores.",
    outputFormat: "Print one integer representing the score of the runner-up. If no runner-up score exists, print -1.",
    constraints: [
      "- 1 <= N <= 100,000",
      "- 0 <= score <= 10^9"
    ],
  ...
  // --- MEDIUM CATEGORY ---
  {
    ...
    inputFormat: "A single line containing a string made only of brackets.",
    outputFormat: "Print one word: true if the code is balanced, otherwise print false.",
    constraints: [
      "- 1 <= string length <= 10,000",
      "- The string contains only these six characters: ( ) { } [ ]"
    ],
    sampleInput: "{[()]}",
    sampleOutput: "true",
  ...
  },
  {
    ...
    inputFormat: "A single line containing the visitor log string.",
    outputFormat: "Print one integer: the starting position (zero-based index) of the first unique user. If none exist, print -1.",
    constraints: [
      "- 1 <= log length <= 100,000",
    ...
    starterCode: {
      ...
      c: "#include <stdio.h>\n#include <string.h>\n\nint firstUnique(char* s) {\n    // TODO: Implement frequency logic\n    return -1;\n}\n\nint main() {\n    char s[100001];\n    if (scanf(\"%s\", s) != EOF) {\n        printf(\"%d\\n\", firstUnique(s));\n    }\n    return 0;\n}",
  ...
  // --- HARD CATEGORY ---
  {
    ...
    constraints: [
      "- 1 <= N <= 100,000",
      "- -10,000 <= profit/loss value <= 10,000"
    ],
    sampleInput: "8\n-2 1 -3 4 -1 2 1 -5",
    sampleOutput: "6",
