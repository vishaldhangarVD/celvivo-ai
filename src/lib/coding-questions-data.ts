/**
 * @fileOverview Nexvoro AI Master Question Data (v33.0).
...
export const MASTER_QUESTIONS: CodingQuestion[] = [
  ...
  },
  {
    ...
    starterCode: {
      ...
      csharp: "using System;\nclass Solution {\n    static bool IsSorted(int[] nums) {\n        for (int i = 0; i < nums.Length - 1; i++) {\n            // TODO: Comparison\n            if (nums[i] > nums[i+1]) return false;\n        }\n        return true;\n    }\n    static void Main() {\n        string first = Console.ReadLine();\n        if (string.IsNullOrEmpty(first)) return;\n        int n = int.Parse(first.Trim());\n        string[] p = Console.ReadLine().Split();\n        int[] nums = new int[n];\n        for(int i=0; i<n; i++) nums[i] = int.Parse(p[i]);\n        Console.WriteLine(IsSorted(nums).ToString().ToLower());\n    }\n}",
  ...
  },
  {
    ...
    starterCode: {
      ...
      csharp: "using System;\nusing System.Collections.Generic;\n\nclass Solution {\n    static void Main() {\n        string first = Console.ReadLine();\n        if (string.IsNullOrEmpty(first)) return;\n        string[] parts = first.Trim().Split();\n        int r = int.Parse(parts[0]);\n        int c = int.Parse(parts[1]);\n        int[][] mat = new int[r][];\n        for(int i=0; i<r; i++) {\n            string[] row = Console.ReadLine().Split(new[]{' '}, StringSplitOptions.RemoveEmptyEntries);\n            mat[i] = new int[c];\n            for(int j=0; j<c; j++) mat[i][j] = int.Parse(row[j]);\n        }\n        // Write your logic here\n    }\n}",
      go: "package main\n\nimport \"fmt\"\n\nfunc main() {\n    var r, c int\n    if _, err := fmt.Scan(&r, &c); err != nil { return }\n    mat := make([][]int, r)\n    for i := 0; i < r; i++ {\n        mat[i] = make([]int, c)\n        for j := 0; j < c; j++ { fmt.Scan(&mat[i][j]) }\n    }\n    // Write your logic here\n}",
      rust: "use std::io::{self, BufRead};\n\nfn main() {\n    let stdin = io::stdin();\n    let mut lines = stdin.lock().lines();\n    if let Some(Ok(line1)) = lines.next() {\n        let dims: Vec<usize> = line1.split_whitespace().map(|s| s.parse().unwrap()).collect();\n        let r = dims[0]; let c = dims[1];\n        let mut matrix = Vec::new();\n        for _ in 0..r {\n            if let Some(Ok(row_line)) = lines.next() {\n                let row: Vec<i32> = row_line.split_whitespace().map(|s| s.parse().unwrap()).collect();\n                matrix.push(row);\n            }\n        }\n        // Write your logic here\n    }\n}",
      kotlin: "import java.util.Scanner\n\nfun main(args: Array<String>) {\n    val sc = Scanner(System.`in`)\n    if (!sc.hasNextInt()) return\n    val r = sc.nextInt(); val c = sc.nextInt()\n    val mat = Array(r) { IntArray(c) }\n    for (i in 0 until r) for (j in 0 until c) mat[i][j] = sc.nextInt()\n    // Write your logic here\n}",
      php: "<?php\n$stdin = fopen('php://stdin', 'r');\n$line1 = fgets($stdin);\nif (!$line1) exit;\nlist($r, $c) = explode(' ', trim($line1));\n$matrix = [];\nfor ($i=0; $i<$r; $i++) {\n    $matrix[] = array_map('intval', explode(' ', trim(fgets($stdin))));\n}\n// Write your logic here\n?>",
      swift: "import Foundation\n\nif let line1 = readLine()?.split(separator: \" \") {\n    let r = Int(line1[0])!; let c = Int(line1[1])!\n    var matrix = [[Int]]()\n    for _ in 0..<r {\n        if let row = readLine()?.split(separator: \" \") {\n            matrix.append(row.map { Int($0)! })\n        }\n    }\n    // Write your logic here\n}",
      ruby: "line1 = gets.split\nr = line1[0].to_i\nc = line1[1].to_i\n# Write your logic here"
    },
    hiddenTestCases: [
      { input: "1 1\n100", output: "100" },
  ...
  },
  {
    ...
    starterCode: {
      ...
      c: "#include <stdio.h>\n#include <stdlib.h>\nint findPeak(int* nums, int n) {\n    int l = 0, r = n - 1;\n    while (l < r) {\n        int mid = (l + r) / 2;\n        if (nums[mid] < nums[mid+1]) l = mid; // BUG\n        else r = mid;\n    }\n    return l;\n}\nint main() {\n    int n; if (scanf(\"%d\", &n) != 1) return 0;\n    int* nums = (int*)malloc(n * sizeof(int));\n    for(int i=0; i<n; i++) scanf(\"%d\", &nums[i]);\n    printf(\"%d\", findPeak(nums, n));\n    free(nums);\n    return 0;\n}",
      csharp: "using System;\nclass Solution {\n    static int FindPeak(int[] nums) {\n        int l = 0, r = nums.Length - 1;\n        while (l < r) {\n            int mid = (l + r) / 2;\n            if (nums[mid] < nums[mid+1]) l = mid; // BUG\n            else r = mid;\n        }\n        return l;\n    }\n    static void Main() {\n        int n = int.Parse(Console.ReadLine());\n        string[] p = Console.ReadLine().Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);\n        int[] nums = new int[n];\n        for(int i=0; i<n; i++) nums[i] = int.Parse(p[i]);\n        Console.WriteLine(FindPeak(nums));\n    }\n}",
      go: "package main\n\nimport \"fmt\"\n\nfunc findPeak(nums []int) int {\n    l, r := 0, len(nums)-1\n    for l < r {\n        mid := (l + r) / 2\n        if nums[mid] < nums[mid+1] { l = mid } // BUG\n        else { r = mid }\n    }\n    return l\n}\n\nfunc main() {\n    var n int\n    fmt.Scan(&n)\n    nums := make([]int, n)\n    for i := 0; i < n; i++ { fmt.Scan(&nums[i]) }\n    fmt.Println(findPeak(nums))\n}",
      rust: "use std::io::{self, BufRead};\n\nfn find_peak(nums: &[i32]) -> usize {\n    let mut l = 0; let mut r = nums.len() - 1;\n    while l < r {\n        let mid = (l + r) / 2;\n        if nums[mid] < nums[mid + 1] { l = mid; } // BUG\n        else { r = mid; }\n    }\n    l\n}\n\nfn main() {\n    let stdin = io::stdin();\n    let mut lines = stdin.lock().lines();\n    if let Some(Ok(line1)) = lines.next() {\n        let n: usize = line1.trim().parse().unwrap();\n        if let Some(Ok(line2)) = lines.next() {\n            let nums: Vec<i32> = line2.split_whitespace().map(|s| s.parse().unwrap()).collect();\n            println!(\"{}\", find_peak(&nums));\n        }\n    }\n}",
      kotlin: "import java.util.Scanner\n\nfun findPeak(nums: IntArray): Int {\n    var l = 0; var r = nums.size - 1\n    while (l < r) {\n        val mid = (l + r) / 2\n        if (nums[mid] < nums[mid + 1]) l = mid // BUG\n        else r = mid\n    }\n    return l\n}\n\nfun main(args: Array<String>) {\n    val sc = Scanner(System.`in`)\n    if (!sc.hasNextInt()) return\n    val n = sc.nextInt()\n    val nums = IntArray(n)\n    for (i in 0 until n) nums[i] = sc.nextInt()\n    println(findPeak(nums))\n}",
      php: "<?php\nfunction findPeak($nums) {\n    $l = 0; $r = count($nums) - 1;\n    while ($l < $r) {\n        $mid = (int)(($l + $r) / 2);\n        if ($nums[$mid] < $nums[$mid + 1]) $l = $mid; // BUG\n        else $r = $mid;\n    }\n    return $l;\n}\n$stdin = fopen('php://stdin', 'r');\n$n = (int)trim(fgets($stdin));\n$nums = array_map('intval', explode(' ', trim(fgets($stdin))));\necho findPeak($nums);\n?>",
  ...
  },
  {
    ...
    starterCode: {
      ...
      go: "package main\n\nimport \"fmt\"\n\nfunc main() {\n    var n, target int\n    if _, err := fmt.Scan(&n, &target); err != nil { return }\n    nums := make([]int, n)\n    for i := 0; i < n; i++ { fmt.Scan(&nums[i]) }\n    // Write your logic here\n}",
      rust: "use std::io::{self, BufRead};\n\nfn main() {\n    let stdin = io::stdin();\n    let mut lines = stdin.lock().lines();\n    if let Some(Ok(line1)) = lines.next() {\n        let parts: Vec<i32> = line1.split_whitespace().map(|s| s.parse().unwrap()).collect();\n        let n = parts[0] as usize; let target = parts[1];\n        if let Some(Ok(line2)) = lines.next() {\n            let nums: Vec<i32> = line2.split_whitespace().map(|s| s.parse().unwrap()).collect();\n            // Write your logic here\n        }\n    }\n}",
  ...
  },
  {
    ...
    starterCode: {
      ...
      csharp: "using System;\nusing System.Collections.Generic;\n\npublic class MinStack {\n    public MinStack() {\n        // Write your logic here\n    }\n    \n    public void Push(int val) {\n        // Write your logic here\n    }\n    \n    public void Pop() {\n        // Write your logic here\n    }\n    \n    public int Top() {\n        // Write your logic here\n        return 0;\n    }\n    \n    public int GetMin() {\n        // Write your logic here\n        return 0;\n    }\n}\n\nclass Solution {\n    static void Main() {\n        string line1 = Console.ReadLine();\n        if (string.IsNullOrEmpty(line1)) return;\n        int q = int.Parse(line1);\n        MinStack obj = new MinStack();\n        for (int i = 0; i < q; i++) {\n            string[] parts = Console.ReadLine().Split();\n            if (parts[0] == \"push\") {\n                obj.Push(int.Parse(parts[1]));\n            } else if (parts[0] == \"pop\") {\n                obj.Pop();\n            } else if (parts[0] == \"top\") {\n                Console.WriteLine(obj.Top());\n            } else if (parts[0] == \"getMin\") {\n                Console.WriteLine(obj.GetMin());\n            }\n        }\n    }\n}",
      go: "package main\n\nimport \"fmt\"\n\ntype MinStack struct {\n    // Add fields here\n}\n\nfunc Constructor() MinStack {\n    // Write your logic here\n    return MinStack{}\n}\n\nfunc (this *MinStack) Push(val int) {\n    // Write your logic here\n}\n\nfunc (this *MinStack) Pop() {\n    // Write your logic here\n}\n\nfunc (this *MinStack) Top() int {\n    // Write your logic here\n    return 0\n}\n\nfunc (this *MinStack) GetMin() int {\n    // Write your logic here\n    return 0\n}\n\nfunc main() {\n    var q int\n    fmt.Scan(&q)\n    obj := Constructor()\n    for i := 0; i < q; i++ {\n        var op string\n        fmt.Scan(&op)\n        if op == \"push\" {\n            var val int\n            fmt.Scan(&val)\n            obj.Push(val)\n        } else if op == \"pop\" {\n            obj.Pop()\n        } else if op == \"top\" {\n            fmt.Println(obj.Top())\n        } else if op == \"getMin\" {\n            fmt.Println(obj.GetMin())\n        }\n    }\n}",
      rust: "struct MinStack {\n    // Add fields here\n}\n\nimpl MinStack {\n    fn new() -> Self {\n        // Write your logic here\n        MinStack {}\n    }\n    \n    fn push(&mut self, val: i32) {\n        // Write your logic here\n    }\n    \n    fn pop(&mut self) {\n        // Write your logic here\n    }\n    \n    fn top(&self) -> i32 {\n        // Write your logic here\n        0\n    }\n    \n    fn get_min(&self) -> i32 {\n        // Write your logic here\n        0\n    }\n}\n\nfn main() {\n    use std::io::{self, BufRead};\n    let stdin = io::stdin();\n    let mut lines = stdin.lock().lines();\n    if let Some(Ok(line1)) = lines.next() {\n        let q: usize = line1.trim().parse().unwrap();\n        let mut min_stack = MinStack::new();\n        for _ in 0..q {\n            if let Some(Ok(line)) = lines.next() {\n                let parts: Vec<&str> = line.split_whitespace().collect();\n                match parts[0] {\n                    \"push\" => min_stack.push(parts[1].parse().unwrap()),\n                    \"pop\" => min_stack.pop(),\n                    \"top\" => println!(\"{}\", min_stack.top()),\n                    \"getMin\" => println!(\"{}\", min_stack.get_min()),\n                    _ => {}\n                }\n            }\n        }\n    }\n}",
      kotlin: "import java.util.Scanner\n\nclass MinStack() {\n    fun push(`val`: Int) {\n        // Write your logic here\n    }\n\n    fun pop() {\n        // Write your logic here\n    }\n\n    fun top(): Int {\n        // Write your logic here\n        return 0\n    }\n\n    fun getMin(): Int {\n        // Write your logic here\n        return 0\n    }\n}\n\nfun main(args: Array<String>) {\n    val sc = Scanner(System.`in`)\n    if (!sc.hasNextInt()) return\n    val q = sc.nextInt()\n    val minStack = MinStack()\n    repeat(q) {\n        val op = sc.next()\n        when (op) {\n            \"push\" -> minStack.push(sc.nextInt())\n            \"pop\" -> minStack.pop()\n            \"top\" -> println(minStack.top())\n            \"getMin\" -> println(minStack.getMin())\n        }\n    }\n}",
      php: "<?php\nclass MinStack {\n    function __construct() {\n        // Write your logic here\n    }\n    function push($val) {\n        // Write your logic here\n    }\n    function pop() {\n        // Write your logic here\n    }\n    function top() {\n        // Write your logic here\n        return 0;\n    }\n    function getMin() {\n        // Write your logic here\n        return 0;\n    }\n}\n\n$stdin = fopen('php://stdin', 'r');\n$line = fgets($stdin);\nif (!$line) exit;\n$q = (int)trim($line);\n$minStack = new MinStack();\nfor ($i = 0; $i < $q; $i++) {\n    $line = trim(fgets($stdin));\n    $parts = explode(' ', $line);\n    if ($parts[0] == \"push\") $minStack->push((int)$parts[1]);\n    elseif ($parts[0] == \"pop\") $minStack->pop();\n    elseif ($parts[0] == \"top\") echo $minStack->top() . \"\\n\";\n    elseif ($parts[0] == \"getMin\") echo $minStack->getMin() . \"\\n\";\n}\n?>",
      swift: "import Foundation\n\nclass MinStack {\n    init() {\n        // Write your logic here\n    }\n    func push(_ val: Int) {\n        // Write your logic here\n    }\n    func pop() {\n        // Write your logic here\n    }\n    func top() -> Int {\n        // Write your logic here\n        return 0\n    }\n    func getMin() -> Int {\n        // Write your logic here\n        return 0\n    }\n}\n\nif let line1 = readLine(), let q = Int(line1) {\n    let minStack = MinStack()\n    for _ in 0..<q {\n        if let line = readLine() {\n            let parts = line.split(separator: \" \")\n            let op = String(parts[0])\n            if op == \"push\" {\n                minStack.push(Int(parts[1])!)\n            } else if op == \"pop\" {\n                minStack.pop()\n            } else if op == \"top\" {\n                print(minStack.top())\n            } else if op == \"getMin\" {\n                print(minStack.getMin())\n            }\n        }\n    }\n}",
